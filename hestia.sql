-- Active: 1726643417635@@127.0.0.1@5433@hestia@public
--
...
VALUES 
('bouwinvest', ' https://www.wonenbijbouwinvest.nl/api/search', 'GET', '{"user_agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.3"}', '{}', '{}', true);
...
CREATE TABLE hestia.subscribers (
    ...
    filter_agencies json DEFAULT '["bouwinvest"]'::json NOT NULL,
);
